"""
    Title: Ship Serializers
    Description: This file will contain all functions for ship serializers.
...
from api.globals.project import API_ZERO, API_CHAR_LEN, API_MAX_CHAR_LEN, DEFAULT_CHAR_LEN, BASE_TEN, PRICE_PRECISION, \
    MAX_INSURANCE_DIGITS, NO_INSURANCE
from api.models import Shipment, Package, Leg
...
class ShipAccountRequestSerializer(serializers.Serializer):
...
class ShipPublicRequestSerializer(serializers.Serializer):
...
class ShipResponseSerializer(serializers.ModelSerializer):
