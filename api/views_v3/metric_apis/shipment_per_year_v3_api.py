...
from api.apis.metric_v3.metric_shipment_per_year_v3 import GetMetricShipmentPerYear
...
class MetricShipmentPerYearApi(UbbeMixin, APIView):
    """
    ...
    @staticmethod
    def _get_cached_data(metrics: GetMetricShipmentPerYear, sub_account: SubAccount, params: dict, metric_type: str) -> dict:
        """
    ...
    @swagger_auto_schema(
        ...
        operation_id='Get Metric Shipment Per Year',
        operation_description='Get metric shipment per year which breaks down the shipment count per month for the '
                              'last four years.',
        responses={
            '200': "Metric data",
            '400': "Bad Request",
    ...
    def get(self, request, *args, **kwargs):
        """
            Get Metric Shipment Per Year Overview.
            :param request: request
            :return: Json list of shipment per month per year.
        """
        errors = []
        ...
        if not account:
            ...
            return Utility.json_error_response(
                code="7300", message="MetricShipmentPerYear: Invalid params.", errors=errors
            )
        ...
        try:
            ...
            return Utility.json_error_response(
                code="7301", message="MetricShipmentPerYear: Account Not found.", errors=errors
            )
        ...
        try:
            ...
            return Utility.json_error_response(
                code="7302", message="MetricShipmentPerYear: Invalid param.", errors=errors
            )
        ...
        metrics = GetMetricShipmentPerYear()
        ...
        if not sub_account.is_bbe:
            ...
            try:
                metric_data = self._get_cached_data(
                    metrics=metrics, sub_account=sub_account, params=params, metric_type="shipment_per_year"
                )
        ...
        try:
            ...
            return Utility.json_error_response(
                code="7303", message="MetricShipmentPerYear: Invalid param.", errors=errors
            )
